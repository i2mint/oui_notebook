...
def load_store_child(store_varname, child_path):
    try:
        ...
        js_target.update(Javascript(f'window.otosense.childIsReady({{ meta: {meta}, keys: {child_keys} }});'))
